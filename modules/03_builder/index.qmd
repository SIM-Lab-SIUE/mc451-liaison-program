...
#### 📋 Codebook Walkthrough
<span class="resource-badge difficulty">Beginner</span>

Step-by-step guide to building your codebook, with a worked example using a framing analysis study. Includes a complete variable list, coding rules, and a sample decisions log.

[Read Codebook Walkthrough](codebook-walkthrough.qmd){.btn .btn-sm .btn-secondary}
:::
...
Annotated examples of strong and weak research questions, with before/after revisions and a checklist for evaluating your own RQ.

[View RQ Examples](rq-examples.qmd){.btn .btn-sm .btn-secondary}
:::
...
→ **[Phase IV: The Analyst](../04_analyst/index.qmd)** - Analyze your data using R
...
:::{.phase-navigation}
← [Phase II: The Architect](../02_architect/index.qmd){.phase-nav-prev}

<span class="phase-progress">Phase 3 of 5</span>

[Phase IV: The Analyst →](../04_analyst/index.qmd){.phase-nav-next}
:::
